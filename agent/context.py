"""Backward-compatibility shim. ConversationContext lives in core.memory.short_term."""

from core.memory.short_term import ConversationContext  # noqa: F401

# Legacy import alias so existing callers continue to work.
if False:
