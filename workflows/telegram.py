"""Workflow: compose and send the monthly home maintenance digest via Telegram."""
...
def build_monthly_digest() -> str:
    ...
    if overdue:
        ...
        if len(overdue) > 10:
            lines.append(f"  _...and {len(overdue) - 10} more_")
        lines.append("")
    else:
